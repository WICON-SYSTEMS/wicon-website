      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 30px; background: #f9fafb;">
          ...
          <div style="background: white; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #3b82f6;">
            ...
            ${
              propertyType
                ? `<p style="margin: 5px 0; color: #4b5563;"><strong>Property Type:</strong> ${propertyType}</p>`
                : ""
            }
            ${
              propertySize
                ? `<p style="margin: 5px 0; color: #4b5563;"><strong>Property Size:</strong> ${propertySize}</p>`
                : ""
            }
            ${
              projectType
                ? `<p style="margin: 5px 0; color: #4b5563;"><strong>Project Type:</strong> ${projectType}</p>`
                : ""
            }
            ${
              budget
                ? `<p style="margin: 5px 0; color: #4b5563;"><strong>Budget Range:</strong> ${budget}</p>`
                : ""
            }
            ${
              urgency
                ? `<p style="margin: 5px 0; color: #4b5563;"><strong>Timeline:</strong> ${urgency}</p>`
                : ""
            }
            ${
              timeline
                ? `<p style="margin: 5px 0; color: #4b5563;"><strong>Timeline:</strong> ${timeline}</p>`
                : ""
            }
            <p style="margin: 5px 0; color: #4b5563;"><strong>Preferred Contact:</strong> ${
          ...
          <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb;">
            <p style="color: #6b7280; font-size: 14px; margin: 0;">
              For urgent electrical issues, call our emergency line: <strong>+237 674802971</strong>
            </p>
          </div>
        </div>
    ...
    try {
      ...
      if (adminEmail) {
        const adminSubject = `New ${
          propertyType ? "Quote Request" : "Contact Form"
        } Submission - ${firstName} ${lastName}`;
        const adminHtml = `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            <h2 style="color: #1f2937; border-bottom: 2px solid #f59e0b; padding-bottom: 10px;">New ${
              propertyType ? "Quote Request" : "Contact Form"
            } Submission</h2>
