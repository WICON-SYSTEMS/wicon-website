...
export default function VolunteerDetailPage() {
  ...
  useEffect(() => {
    async function load() {
      ...
      setError(null)
      try {
        const res = await fetch(`/api/admin/training/volunteers/${id}`, { headers })
  ...
  async function updateStatus(type: "accept" | "decline") {
    ...
    try {
      ...
      const statusRes = await fetch(`/api/admin/training/volunteers/${id}/status`, {
        method: 'PATCH',
      ...
      const subject = type === "accept" ? "Your volunteer application" : "Your volunteer application"
      const body = type === "accept"
        ? `<p>Hi ${name},</p><p>We are pleased to inform you that your volunteer application has been accepted.</p>${message ? `<p>${message}</p>` : ""}`
      ...
      <header className="sticky top-0 z-30 bg-white/80 backdrop-blur border-b">
        <div className="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold">{BRAND_NAME} • Volunteer</span>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-lg bg-white p-4 shadow">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="flex items-center gap-3">
                  <h1 className="text-xl font-semibold">Volunteer Application Details</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="md:col-span-2 rounded-lg bg-white p-4 shadow">
                <h2 className="mb-4 text-lg font-semibold">Volunteer Information</h2>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="mx-4 w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
            ...
            <p className="mb-4 text-sm text-gray-600">
              Are you sure you want to {showConfirmDialog} this volunteer application? An email will be sent to the applicant.
            </p>
            <div className="mb-4">
            ...
            <div className="flex justify-end gap-3">
              ...
              >
                {isUpdating ? 'Processing...' : `${showConfirmDialog === 'accept' ? 'Accept' : 'Decline'} Application`}
              </button>
            </div>
          </div>
        </div>
